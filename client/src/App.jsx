...
function App() {
  ...
  return (
    <div className="bg-gray-900 text-white flex flex-col h-screen p-4 font-mono">
      <header className="mb-4">
        <h1 className="text-3xl font-bold text-cyan-400">Chat TCP com Electron + Node.js</h1>
